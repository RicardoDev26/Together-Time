    ...
    return (
        <StyledView className="w-full h-full items-center mt-5">
            ...
            <StyledView className="mb-5">
                <StyledTouchableOpacity className="bg-dark-charcoal rounded-lg w-[350px] p-3 justify-center items-center">    
                    <StyledText className="text-center text-white text-base font-medium">Edit Profile</StyledText>
